module Ckeditor
  ...
  PLUGIN_PATH = File.join(Rails.root, "vendor/plugins", PLUGIN_NAME)
  
  PLUGIN_PUBLIC_PATH = Ckeditor::Config.exists? ? Ckeditor::Config['public_path'] : "#{Rails.root}/public/uploads"
